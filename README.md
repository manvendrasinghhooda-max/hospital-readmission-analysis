...
- Diabetes patients had slightly higher readmission percentages
...
## Dashboard Preview
![Dashboard](https://github.com/username/repository-name/blob/main/hospital_dashboard.png?raw=true)
